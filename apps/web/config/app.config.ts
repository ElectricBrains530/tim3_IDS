...
const AppConfigSchema = z
  .object({
    name: z
      .string({
        message: `Please provide the variable NEXT_PUBLIC_PRODUCT_NAME`,
      })
      .describe(`This is the name of your SaaS. Ex. "Makerkit"`)
      .min(1),
    title: z
      .string({
        message: `Please provide the variable NEXT_PUBLIC_SITE_TITLE`,
      })
      .describe(`This is the default title tag of your SaaS.`)
      .min(1),
    description: z.string({
      message: `Please provide the variable NEXT_PUBLIC_SITE_DESCRIPTION`,
    }).describe(`This is the default description of your SaaS.`),
    url: z
      .string({
        message: `Please provide the variable NEXT_PUBLIC_SITE_URL`,
      })
      .url({
    ...
    locale: z
      .string({
        message: `Please provide the variable NEXT_PUBLIC_DEFAULT_LOCALE`,
      })
